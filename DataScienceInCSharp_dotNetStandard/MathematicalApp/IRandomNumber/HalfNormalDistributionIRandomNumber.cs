...
namespace Tremendous1192.SelfEmployed.DataScienceInCSharp_dotNetStandard.MathematicalApp
{
    ...
    public partial class HalfNormalDistributionIRandomNumber : IRandomNumber
    {
        ...
        /// 一様分布
        /// </summary>
        UniformDistributionIRandomNumber ud1, ud2;
        ...
        /// constructor
        /// </summary>
        public HalfNormalDistributionIRandomNumber()
        {
            seed1 = (uint)Math.Abs(DateTime.Now.Millisecond);
            seed2 = seed1 + 1;
            ud1 = new UniformDistributionIRandomNumber(seed1);
            ud2 = new UniformDistributionIRandomNumber(seed2);
        ...
        public HalfNormalDistributionIRandomNumber(uint the_seed_1, uint the_seed_2)
        {
            seed1 = the_seed_1;
