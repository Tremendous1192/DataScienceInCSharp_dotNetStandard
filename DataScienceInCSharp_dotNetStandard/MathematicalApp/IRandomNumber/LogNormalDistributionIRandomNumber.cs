...
namespace Tremendous1192.SelfEmployed.DataScienceInCSharp_dotNetStandard.MathematicalApp
{
    ...
    public partial class LogNormalDistributionIRandomNumber : IRandomNumber
    {
        ...
        /// constructor
        /// </summary>
        public LogNormalDistributionIRandomNumber()
        {
        ...
        public LogNormalDistributionIRandomNumber(uint the_seed_1, uint the_seed_2)
        {
            seed1 = the_seed_1;
