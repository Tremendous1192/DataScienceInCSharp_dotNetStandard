...
namespace Tremendous1192.SelfEmployed.DataScienceInCSharp_dotNetStandard.MathematicalApp
{
    ...
    /// Polor法で生成した正規分布の乱数
    /// </summary>
    public partial class NormalDistributionIRandomNumber : IRandomNumber
    {
        ...
        /// constructor
        /// </summary>
        public NormalDistributionIRandomNumber()
        {
        ...
        public NormalDistributionIRandomNumber(uint the_seed_1, uint the_seed_2)
        {
            seed1 = the_seed_1;
