...
{
    public partial class UniformDistributionIRandomNumber : IRandomNumber
    {
        ...
        /// constructor
        /// </summary>
        public UniformDistributionIRandomNumber()
        {
        ...
        /// constructor
        /// </summary>
        public UniformDistributionIRandomNumber(uint the_seed)
        {
            seed = the_seed;
            X = 123456789;
            Y = (UInt32)(seed >> 32) & 0xFFFFFFFF;
