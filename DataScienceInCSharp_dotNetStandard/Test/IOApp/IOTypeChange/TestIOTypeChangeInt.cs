...
namespace Test.Tremendous1192.SelfEmployed.DataScienceInCSharp_dotNetStandard.IOApp
{
    public partial class TestIOTypeChange
    {
        ...
        public void TestInt()
        {
            ...
            int[] testArray = new int[8] { 1, -2, 11, -31, -9, 22, 33, -9 };
            ...
            int[,] testArray2 = new int[2, 4] { { 1, -2, 11, -31 }, { -9, 22, 33, -9 } };
            Console.WriteLine("要素番号" + "\t" + "文字列");
            ...
            int[,,] testArray3 = new int[2, 2, 2] { { { 1, -2 }, { 11, -31 } }, { { -9, 22 }, { 33, -9 } } };
            Console.WriteLine("要素番号" + "\t" + "文字列");
            ...
            int[,,,] testArray4 = new int[2, 2, 2, 1] { { { { 1 }, { -2 } }, { { 11 }, { -31 } } }, { { { -9 }, { 22 } }, { { 33 }, { -9 } } } };
            Console.WriteLine("要素番号" + "\t" + "文字列");
