...
namespace Test.Tremendous1192.SelfEmployed.DataScienceInCSharp_dotNetStandard.IOApp
{
    public partial class TestIOTypeChange
    {
        ...
        public void TestNullableInt()
        {
            ...
            Console.WriteLine("Nullable intの型変換などに関するテストメソッドです。\n");
            ...
            Console.WriteLine("\n" + "int?[8]に変換します");
            int?[] converted = IOTypeChange.StringToNullableInt(testArray);
            ...
            int?[,] array2Dimension = IOTypeChange.ChangeArray1dimTo2dim(converted, 2, 4);
            ...
            int?[,,] array3Dimension = IOTypeChange.ChangeArray1dimTo3dim(converted, 2, 2, 2);
            Console.WriteLine("要素番号" + "\t" + "値");
            ...
            int?[,,,] array4Dimension = IOTypeChange.ChangeArray1dimTo4dim(converted, 2, 2, 2, 1);
            Console.WriteLine("要素番号" + "\t" + "値");
            ...
            Console.WriteLine("\n\n\n" + "int?[8]のnullの要素番号を示します");
            List<int[]> reportIndex = IOTypeChange.ReportNullableIntIndex(converted);
            ...
            int replacement = -9;
            Console.WriteLine("\n" + "int?[8]のnullを" + replacement + "に変換します");
            int[] replaced = IOTypeChange.ReplaceNull(converted, replacement);
            Console.WriteLine("要素番号" + "\t" + "変換された数");
            for (int i = 0; i < converted.GetLength(0); i++)
            {
            ...
            Console.WriteLine("\n" + "int?[2,4]を表示します");
            int?[,] converted2 = IOTypeChange.StringToNullableInt(testArray2);
            ...
            Console.WriteLine("\n" + "int?[2,4]のnullの要素番号を示します");
            reportIndex = IOTypeChange.ReportNullableIntIndex(converted2);
            Console.WriteLine("要素番号" + "\t" + "変換できなかった文字列");
            for (int i = 0; i < reportIndex.Count; i++)
            {
                Console.Write("[");
            ...
            Console.WriteLine("\n" + "int?[2,4]のnullを" + replacement + "に変換します");
            int[,] replaced2 = IOTypeChange.ReplaceNull(converted2, replacement);
            Console.WriteLine("要素番号" + "\t" + "変換された数");
            for (int i = 0; i < converted2.GetLength(0); i++)
            {
                for (int j = 0; j < converted2.GetLength(1); j++)
            ...
            Console.WriteLine("\n" + "int?[2,2,2]を表示します");
            int?[,,] converted3 = IOTypeChange.StringToNullableInt(testArray3);
            ...
            Console.WriteLine("\n" + "int?[2,2,2]のnullの要素番号を示します");
            reportIndex = IOTypeChange.ReportNullableIntIndex(converted3);
            Console.WriteLine("要素番号" + "\t" + "変換できなかった文字列");
            for (int i = 0; i < reportIndex.Count; i++)
            {
                Console.Write("[");
            ...
            Console.WriteLine("\n" + "int?[2,2,2]のnullを" + replacement + "に変換します");
            int[,,] replaced3 = IOTypeChange.ReplaceNull(converted3, replacement);
            Console.WriteLine("要素番号" + "\t" + "変換された数");
            for (int i = 0; i < converted3.GetLength(0); i++)
            {
                for (int j = 0; j < converted3.GetLength(1); j++)
            ...
            Console.WriteLine("\n\n\n" + "次のstring[2,2,2,1]をint?[2,2,2]に変換します");
            ...
            Console.WriteLine("\n" + "int?[2,2,2,1]を表示します");
            int?[,,,] converted4 = IOTypeChange.StringToNullableInt(testArray4);
            ...
            Console.WriteLine("\n" + "int?[2,2,2,1]のnullの要素番号を示します");
            reportIndex = IOTypeChange.ReportNullableIntIndex(converted4);
            Console.WriteLine("要素番号" + "\t" + "変換できなかった文字列");
            for (int i = 0; i < reportIndex.Count; i++)
            {
                Console.Write("[");
            ...
            Console.WriteLine("\n" + "int?[2,2,2,1]のnullを" + replacement + "に変換します");
            int[,,,] replaced4 = IOTypeChange.ReplaceNull(converted4, replacement);
            Console.WriteLine("要素番号" + "\t" + "変換された数");
            for (int i = 0; i < converted4.GetLength(0); i++)
            {
                for (int j = 0; j < converted4.GetLength(1); j++)
